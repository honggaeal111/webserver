  ...
  <body>
    <div class="top">
        ...
        <div class="menu">
          ...
          <div class="board" style="cursor:pointer" onclick="location.href='freeboard/list.php'">bulletin board</div>
    ...
    <form name="login" method=post action=login.php>
      <div class="grid">
        ...
        <div class="button">
          ...
          <input type="button" style="cursor:pointer" value="회원정보" onclick="logoutt();">
        </div>
      </form>
      <div class="free">
        여기에 자유게시판
